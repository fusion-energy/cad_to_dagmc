...
def test_mesh_to_dagmc_with_meshfile():
    gmsh.initialize()
    gmsh.open("tests/tagged_mesh.msh")

    test_h5m_filename = "dagmc_from_gmsh_obj.h5m"
    cad_to_dagmc.export_gmsh_file_to_dagmc_h5m_file(dagmc_filename=test_h5m_filename)
    gmsh.finalize()
...
def test_mesh_to_dagmc_with_mesh_object():
    ...
    test_h5m_filename = "dagmc_from_gmsh_obj.h5m"
    cad_to_dagmc.export_gmsh_object_to_dagmc_h5m_file(dagmc_filename=test_h5m_filename)
    gmsh.finalize()
